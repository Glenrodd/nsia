...
class AliasController extends Controller
{
	...
	/*public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Alias'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_alias));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Alias');
	 ...
	 * @param Alias $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='alias-form')
		{
