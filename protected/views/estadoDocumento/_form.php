            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
        			<label>
					<?php echo $form->labelEx($model,'estado_documento'); ?>
        			</label>
					<?php echo $form->textField($model,'estado_documento',array('size'=>45,'maxlength'=>45,'class'=>'form-control')); ?>
					<?php echo $form->error($model,'estado_documento'); ?>
                  </div>
                  <div class="form-group">
        			<label>
