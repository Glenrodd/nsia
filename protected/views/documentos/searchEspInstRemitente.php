...
<h4><b>B&uacute;squeda por Instituci&oacute;n Remitente</b></h4>
	              	...
	              	<div class="col-md-6">
	              		<div class="card-body">
							 ...
							 <div class="form-group">
								...
								<?php echo $form->labelEx($model,'Instituci&oacute;n Remitente *'); ?>
								<?php echo $form->textArea($model,'remitente_institucion',array('size'=>60,'maxlength'=>100,'class'=>'form-control')); ?>
