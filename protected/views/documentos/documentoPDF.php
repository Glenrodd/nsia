...
<table align="left" width="85%" border="0" cellpadding="4">
  ...
  <?php   } //for($i=0; $i<count($row_via); $i++)
	...
	?>
	<tr>
		<th align="left"  width="15%" style="font-size: 15px; font-family: Verdana, Geneva, sans-serif;">
			<?php if($j==0){ echo "De:";} 
				  else{ echo " "; }	
				?>
		</th>
		<td align="left"  width="85%" style="font-size: 15px; font-family: Verdana, Geneva, sans-serif;">
			<?=$row_remitente[$j]; ?><br>
...
<table align="left" width="95%" border="0" cellpadding="4">
	...
	<tr>
		<th align="left" width="15%" style="font-size: 15px; font-family: Verdana;">Ref.: </th>
		<td align="left" width="85%" style="font-size: 15px; font-family: Verdana;">
			<u><?=$documentos->referencia; ?></u>
		</td>
	</tr>
</table>
...
<?php
// codigo para reemplazar los bordes generados automaticamente
