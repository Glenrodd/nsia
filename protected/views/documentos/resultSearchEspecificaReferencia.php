            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">
                	...
                	Resultado de b&uacute;squeda  por <b>Referencia</b></h3>
              </div>
              <!-- /.card-header -->
	              ...
	              <div class="card-body">
                	...
                	<div class="card-body pad table-responsive">
                		...
                		?>
								<center><h4><u><b><?=$tipoDocumentos->tipo_documento?> (Referencia)</b></u></h4>
						        ...
						        <table id="example" class="display" style="width:100%">
						         ...
						         <?php $dataReader=Documentos::getSearchEspecificaReferencia($referencia,$tipo,$gestion); ?>	
