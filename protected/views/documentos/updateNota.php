          ...
          <div class="col-md-12">
            ...
            <center>
              <div class="card-body">
                ...
                <a class="btn btn-app" href="index.php?r=documentos/asignarNuevoCite&id=<?=$model->id_documento?>"  style="color: black;" onclick="return confirm('Are you sure?'); event.stopPropagation(); Loading.show(); return true;"  >
