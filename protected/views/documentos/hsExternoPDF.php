...
<!--#####################################################################-->		
	...
	<table border="0" cellpadding="4px" cellspacing="0" width="100%" class="tabla_hs">
		<tr align="center">
			...
			<th style="width:62%;"><span style="font-size: 17pt; text-align: center;">
				HOJA DE SEGUIMIENTO</span>
			</th>
			
			<th style="width:26%;" colspan="2">
				NUR<br>
		...
		<tr style="font-size: 10pt; ">
			<th style="font-size:10pt; text-align:left; background-color:#BDBDBD; "><span>Procedencia: </span></th>
			<td  style=" text-align:left; font-size:10pt;" align="left" >
				<?=$documentos->remitente_institucion?>
			</td>
			<th style="font-size:10pt; background-color:#BDBDBD;  "><span>Fecha: </span></th>
			<td align="left" style="font-size:10pt;" ><?=Yii::app()->dateFormatter->format("dd/MM/y",strtotime($hojasruta->fecha))?>&nbsp;&nbsp;<?=$hojasruta->hora?></td>
		</tr>
		<tr>
			<th style="font-size:10pt; text-align:left; background-color:#BDBDBD;"><span>CITE: </span></th>
			<td align="left" style="font-size: 10pt;" colspan="3" ><?=$documentos->codigo?></td>
		</tr>
		
		<tr style="font-size: 10pt;">
			<th style="font-size: 10pt; text-align:left; background-color:#BDBDBD;"><span>Remitente: </span></th>
		...
		<tr style="font-size: 10pt;">
			<th style="font-size: 10pt; text-align:left; background-color:#BDBDBD;"><span>Referencia: </span></th>
			<td style="text-align:left; font-size: 10pt; width: 20px; " align="left" colspan="3" valign="top" >
		...
		<tr style="font-size: 10pt;">
			<th  style="font-size: 10pt; text-align:left; background-color:#BDBDBD;"><span>Adjuntos: </span></th>
			<td align="left"  style="text-align:left; font-size: 10pt;" >
				<?=$documentos->adjuntos?>
			</td>
			<th style="font-size: 10pt; background-color:#BDBDBD; "><span>Hojas: </span></th>
			<td align="left" style="font-size: 10pt; width: 350px;" ><?=$documentos->nro_hojas?></td>
		</tr>
		<tr style="font-size: 10pt;">
			<th style="font-size: 10pt; text-align:left; background-color:#BDBDBD;"><span>Sintesis: </span></th>
			<td style="text-align:left; font-size: 9pt;" align="left" colspan="3" valign="top" >
	...
	<table class="tabla_hs" cellpadding="4px" cellspacing="0" style="border-top: 1.5mm;"  width="100%">
		...
		<tr style="font-size: 8pt;">
			...
			<th  style="border-bottom: 0mm; width:0; font-size: 8pt; text-align: left;  width: 60%; background-color:#BDBDBD;" >
				MOTIVO:&nbsp;&nbsp; <?=$documentos->fkMotivo->motivo?> 
			</th>
	...
	<table class="tabla_hs" cellpadding="4px" cellspacing="0" width="100%">
		<tr style="border-top:0mm;">
			...
			<td style="width: 60%; text-align: left; font-size:7pt;">
				<!--<? //=Documentos::getNameAreaDerivacion($seguimientos->derivado_a)?>-->
				<?=$seguimientos->derivadoA->fkArea->area?>
			</td>
