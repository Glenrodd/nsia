...
function destinatarioGrupo(valor1, valor2){	

	//$("#grupo_destino").val(valor1);
	//$("#nombre_grupo").val(valor2);
	$("#destinatario_nombres").val(valor2);
	$("#destinatario_cargo").val('null');
	$("#grupo_destino").val(valor1);
}
  ...
  setInterval(
     function(){
        ...
        if(statusnya!="on")  // si no hay ninguna función en ejecución, ejecute la función
        {
           ...
           $.ajax({
              url: "<?php echo Yii::app()->createUrl('documentos/updateCircularDraft')?>",  // llama a una función para guardar automáticamente
              type:"post",
              dataType :"json",
              data:{"id_documento":id_documento, "destinatario_nombres":destinatario_nombres, "destinatario_cargo":destinatario_cargo, "referencia":referencia, "contenido":contenido, "remitente_nombres":remitente_nombres, "remitente_cargo":remitente_cargo, "adjuntos":adjuntos, "copias":copias},
              beforeSend: function() {
                    $("#statuta").val("on");
...
<?php $form=$this->beginWidget('CActiveForm', array(
	              	...
	              	<div class="col-md-6">
	              		<div class="card-body">
			                  ...
			                  <div class="form-group">
								...
								<?php echo $form->hiddenField($model,'nombre_grupo',array('size'=>60,'maxlength'=>500,'class'=>'form-control','id'=>'nombre_grupo','value'=>'null')); ?>
			                   ...
			                   <div class="form-group">
								...
								<?php echo $form->textArea($model,'referencia',array('rows'=>4, 'cols'=>50,'class'=>'form-control')); ?>
		              		...
		              		<div class="card-body">
					              ...
					              <!-- /.card-header -->
					               <div class="card-body">
					              		...
					              		<div class="card-body pad table-responsive"  style="height:250px; overflow:auto; border:1px solid lightgray; border-radius: 5px;">
					              ...
					              <!-- /.card-header -->
					               <div class="card-body">
						                ...
						                <table class="table table-bordered table-striped">
			  							...
			  							$dataReader=Documentos::listadoGrupos();
									 	foreach($dataReader as $row) {
						              	  ?>
											...
											<tr  style="font-size: 12px;">
											  ...
											  <a onclick="javascript:destinatarioGrupo('<?php echo $row['id_grupo_derivacion'] ?>','<?php echo $row['nombre_grupo'] ?>');" style="text-decoration:none; color: white;font-size: 12px;" class='btn btn-primary'>Destino</a>
	...
	?>	
		...
		<?php echo $form->hiddenField($model,'grupo_destino',array('id'=>'grupo_destino','value'=>1)); ?>
