              ...
              <div class="card-body">
               ...
               ?>
                ...
                <!--<a class="btn btn-app" href="index.php?r=areas/admin" style="color: black;">
                 ...
                 <a class="btn btn-app" href="index.php?r=documentos/generarCartaPDF&id_documento=<?=$model->id_documento?>&id_hoja_ruta=<?=$row['id_hoja_ruta']?>" style="color: black;">
                  <i class="fa fa-file-pdf-o"></i>Generar Documento
                </a>

                
                <a class="btn btn-app" href="index.php?r=documentos/generarCartaWORD&id_documento=<?=$model->id_documento?>&id_hoja_ruta=<?=$row['id_hoja_ruta']?>" style="color: black;">
                  <i class="fa fa-file-word-o"></i>Generar Word
               </a>
            ...
            <center>
              <div class="card-body pad table-responsive">
                <table cellpadding="1px" width="80%" class="table-bordered table-striped" >
                  <?php 
                  // codigo para verificar el documento esta asociado a un nuri que tiene seguimiento
                  // en caso de tener seguimiento no se muestra el detalle de cites asignados
              ...
              <?php } //foreach ($dataReader as $row2) {
                ...
                echo "<tr>
                       <td align='center'>
                        <b>Documento observado <br></b>
                        <i>Por favor actualice la informaci&oacute;n</i>
                       </td>
                      </tr>";
                }
