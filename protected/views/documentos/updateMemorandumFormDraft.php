  ...
  setInterval(
     function(){
        ...
        if(statusnya!="on")  // si no hay ninguna función en ejecución, ejecute la función
        {
           ...
           $.ajax({
              url: "<?php echo Yii::app()->createUrl('documentos/updateMemorandumDraft')?>",  // llama a una función para guardar automáticamente
              type:"post",
              dataType :"json",
              data:{"id_documento":id_documento, "destinatario_nombres":destinatario_nombres, "destinatario_cargo":destinatario_cargo, "referencia":referencia, "contenido":contenido, "remitente_nombres":remitente_nombres, "remitente_cargo":remitente_cargo, "adjuntos":adjuntos},
              beforeSend: function() {
                    $("#statuta").val("on");
	              		...
	              		<div class="card-body">
			                  ...
			                  <div class="form-group">
			                   ...
			                   <div class="form-group">
								...
								<?php echo $form->textArea($model,'referencia',array('rows'=>3, 'cols'=>50,'class'=>'form-control')); ?>
