            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">
                	...
                	Resultado de b&uacute;squeda por <b>CITE</b></h3>
              </div>
              <!-- /.card-header -->
	              ...
	              <div class="card-body">
                	...
                	<div class="card-body pad table-responsive">
                		...
                		?>
								<center><h4><u><b><?=$tipoDocumentos->tipo_documento?> (CITE)</b></u></h4>
						        ...
						        <table id="example" class="display" style="width:100%">
						         ...
						         <?php $dataReader=Documentos::getSearchEspecificaCite($cite,$tipo,$gestion); ?>	
						         <?php foreach ($dataReader as $row) { ?>	
						           <tr>
						            <td align="center">
						            	...
						            	?>
						            	<a href="index.php?r=seguimientos/busquedaIndex&nuri=<?=Documentos::getObtenerNur($row['id_documento'])?>" style="font-size: 14px;">
						            	<?php 
						            		echo Documentos::getObtenerNuriBusqueda($row['id_documento']);
						            ...
						            <td align="left">
						            	<?=htmlentities($row['destinatario'])?><br>
						            	<b><i><?=htmlentities($row['cargo_destinatario'])?></i></b>
						            </td>
						            <td align="left"><?=htmlentities($row['referencia'])?></td>
						            ...
						            <!--<td align="center">
                						...
                						<a class="btn btn-app" href="index.php?r=seguimientos/busquedaIndex&nuri=<? //=Documentos::getObtenerNur($row['id_documento'])?>" style="color: black;">
