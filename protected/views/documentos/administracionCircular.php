		...
		array(
			...
			'buttons'=>array(
				'imprimirDocumento' => array(
					...
					'url'=>"CHtml::normalizeUrl(array('documentos/generarCircularPDF', 'id_documento'=>\$data->id_documento, 'id_hoja_ruta'=>\$data->getObtenerIDNuri(\$data->id_documento)
					        ))",
					//'imageUrl'=>Yii::app()->request->baseUrl.'/images/add_user.png',
			    ...
			    'editar' => array(
					...
					'url'=>"CHtml::normalizeUrl(array('documentos/updateCircularUser', 'id'=>\$data->id_documento, 'tipo'=>\$data->fk_tipo_documento 
					        ))",
					//'imageUrl'=>Yii::app()->request->baseUrl.'/images/add_user.png',
