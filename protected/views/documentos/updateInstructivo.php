          ...
          <div class="col-md-12">
            ...
            <center>
              <div class="card-body">
               ...
               <a class="btn btn-app" href="index.php?r=documentos/generarInstructivoPDF&id_documento=<?=$model->id_documento?>&id_hoja_ruta=<?=$row['id_hoja_ruta']?>" style="color: black;">
                  <i class="fa fa-file-pdf-o"></i>Generar Documento
                </a>
                <?php //if (Yii::app()->user->id_usuario==1) { ?>
                <a class="btn btn-app" href="index.php?r=documentos/generarInstructivoWORD&id_documento=<?=$model->id_documento?>&id_hoja_ruta=<?=$row['id_hoja_ruta']?>" style="color: black;">
                  <i class="fa fa-file-word-o"></i>Generar Word
                </a>
                <?php //} ?>
   ...
   <div class="col-md-4">
        ...
        <div class="card-body">
          <h3 style="color:#0B4C5F;" >
            <i class="icon fa fa-file-code-o" style="font-size:40px;" ></i>
...
<?php $this->renderPartial('_formInstructivo', array('model'=>$model,'tipo'=>$tipo)); ?>