...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'documentos-grid',
	'dataProvider'=>$model->searchDocumento(1,2019),
	'filter'=>$model,
	...
	'columns'=>array(
		...
		*/
		...
		array(
			'class'=>'CButtonColumn',
			'template' => '{imprimirDocumento}{seguimiento}{editar}',//{addUsuario}
			'htmlOptions'=>array('width'=>'290px','style'=>'text-align:center',),
