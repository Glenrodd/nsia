...
<table align="center" width="85%" border="0" cellpadding="4">
  ...
  <?php   } //for($i=0; $i<count($row_via); $i++)
	...
	<?php	$row_remitente=Documentos::getRowExplode($documentos->remitente_nombres,';'); 
	...
	?>
	<tr>
		<th align="left"  width="15%" style="font-size: 15px; font-family: Verdana;" valign="top">
			<?php if($j==0){ echo "De:";} 
				  else{ echo " "; }	
				?>
		</th>
...
<table align="left" width="95%" border="0" cellpadding="4">
	...
	<tr>
		<th align="left" width="15%" style="font-size: 15px; font-family: Verdana;">Objeto: </th>
		<td align="left" width="85%" style="font-size: 15px; font-family: Verdana;">
			<u><b><?=$documentos->referencia; ?></b></u>
		</td>
	</tr>
</table>
