  ...
  setInterval(
     function(){
        ...
        if(statusnya!="on")  // si no hay ninguna función en ejecución, ejecute la función
        {
           ...
           $.ajax({
              url: "<?php echo Yii::app()->createUrl('documentos/updateNotaDraft')?>",  // llama a una función para guardar automáticamente
              type:"post",
              dataType :"json",
