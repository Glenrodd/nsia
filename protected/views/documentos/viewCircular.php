...
<h3><strong>Ver Circular #<?php echo $model->id_documento; ?></strong></h3>
                ...
                <table class="table table-bordered text-center">
                  <tr>
                    <td>
                      ...
                      <?php echo CHtml::link('Administración Circulares',array('documentos/administracionCircular', 'tipo_documento'=>$model->fk_tipo_documento,'gestion'=>$model->gestion), array('class'=>'btn btn-block btn-success')); ?>
                    </td>
                  </tr>
