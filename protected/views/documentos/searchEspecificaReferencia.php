...
<h4><b>B&uacute;squeda por REFERENCIA</b></h4>
	              	...
	              	<div class="col-md-4">
	              		<div class="card-body">
							 ...
							 <div class="form-group">
								...
								<?php echo $form->textArea($model,'referencia',array('size'=>60,'maxlength'=>100,'class'=>'form-control')); ?>
		            ...
		            <div class="col-md-4">
		            	<div class="card-body">
		            		<div class="form-group">
								...
								<?php echo $form->dropDownList($model,'fk_tipo_documento', $model->getListTipoDocumento(),array('class'=>'form-control  select', 'empty'=>'Seleccione Tipo'
								)); ?>
