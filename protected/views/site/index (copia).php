<head>
  ...
  <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/estilo.css?family=Source+Sans+Pro:300,400,400i,700">
...
<!-- Content Wrapper. Contains page content -->
    ...
    <section class="content">
      <div class="container-fluid">
        <h5 class="mb-2">REPORTES VARIOS</h5>
        <div class="row">
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><i>(NURIS derivados por fecha)</i></span>
                <span class="info-box-number">Reportes Gerenciales #1</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><i>(NURIS derivados por fecha)</i></span>
                <span class="info-box-number">Reportes Gerenciales #2</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><i>(NURIS derivados por fecha)</i></span>
                <span class="info-box-number">Reportes Gerenciales #3</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><i>(NURIS derivados por fecha)</i></span>
                <span class="info-box-number">Reportes Gerenciales #4</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <!-- Small Box (Stat card) -->
        <h5 class="mb-2 mt-4">CUADRO RESUMEN</h5>
        <div class="row">
