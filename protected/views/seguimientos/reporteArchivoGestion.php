		        ...
		        <table class="table table-bordered">
                  ...
                  <!-- Default -->
                   <?php 
			            ...
			            $dataReader=ArchivadosDigitales::getArchivoGestion();
		              	   ...
		              	   <tr>
			                    <td>
			                      <div class="btn-group-vertical">
			                        ...
			                        <a class="btn btn-info" href="index.php?r=seguimientos/administracionArchivoOriginal&gestion=<?=$row['gestion']?>" style="color:white;">
